...
Write a function in C++ to update the file with a new value of stock. The value of stock
and the PCODE , whose stock to be updated are read during the execution of the program.*/
...
void addnew(){
    ...
    while(ch!=0){
        ...
        cout<<"\n PRESS ZERO TO STOP/ONE TO CONTINUE: ";
        cin>>ch;
    }
    inoutfile.close();
}
