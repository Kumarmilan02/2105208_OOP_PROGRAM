/*Given a binary file TELE.DAT, containing records of the following class :
class Directory
{
    char Name[20];
    char Address[30];
...
-Write objects of Directory class to the file TELE.DAT.
-Sort the objects according to the area code.
-Insert a new entry into the sorted file at appropriate location.
-Delete an object having a given phone no.
