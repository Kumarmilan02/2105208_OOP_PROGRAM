/*Write a C++ program to implement the GRADING system of KIIT University. The system
will maintain the marks of a student in various subjects using the following class:
class student
{
    int Rollno;
    int marks[8];
...
-To calculate the sgpa based on the marks received.
-To re-calculate the sgpa after new marks received after improvement examination, for a particular roll no student.
-To delete an object for a particular roll no student, after he/she quits from the course.
-Sort the file according to batch.
[This part is optional:
-Try to incorporate CGPA too and calculate it based on the SGPA of all the semesters for a student.
-Sort the file, first batch-wise, then branch-wise and then semester wise.]*/
